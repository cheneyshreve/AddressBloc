...
RSpec.describe AddressBook do
  ...
  describe "#remove_entry" do
    it "removes one entry from the address book" do
      book.add_entry('Michael Faraday', '010.111.123', 'mike@michaelsemail.com')
  ...
  describe "#import_from_csv" do
   ...
   context "importing from another csv file" do
     it "imports the correct number of entries" do
       book.import_from_csv("entries_2.csv")
       book_size = book.entries.size
    ...
    it "imports the 1st entry" do
      ...
      check_entry(first_entry, "Betty", "555-555-5555", "betty@blocmail.com")
    end

    it "imports the 2nd entry" do
      book.import_from_csv("entries_2.csv")
      second_entry = book.entries[1]
      check_entry(second_entry, "Carrie", "555-555-5556", "carrie@blocmail.com")
    end

    it "imports the 3rd entry" do
      book.import_from_csv("entries_2.csv")
      third_entry = book.entries[2]
      check_entry(third_entry, "Gwen", "555-555-5557", "gwen@blocmail.com")
    end
  end
  ...
  context "#delete_all" do
   it "deletes all entries from AddressBook" do
      book.add_entry("Jenn", "123-456-789", "jenn@blocmail.com")
      book.delete_all
      expect(book.entries.size).to eq(0)
   end
  end
